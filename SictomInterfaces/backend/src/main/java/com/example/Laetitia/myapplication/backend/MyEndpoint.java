 ...
 */
@Api(name = "sictomApi", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.myapplication.Laetitia.example.com", ownerName = "backend.myapplication.Laetitia.example.com", packagePath = ""))
