...
import com.example.laetitia.sictom.adapter.NavDrawerListAdapter;
import com.example.laetitia.sictom.modele.NavDrawerItem;
...
//                getActionBar().setTitle(mTitle);
       ...
       /* textView.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
                Intent intent = new Intent(PositionCourante.this, CheminParcouru.class);
