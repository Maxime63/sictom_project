...
public class CheminParcouru extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_chemin_parcouru);
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            case 0:
                ...
                break;
            case 1 :
                intent = new Intent(CheminParcouru.this, PositionCourante.class);
                startActivity(intent);
                break;
            case 2:
                intent = new Intent(CheminParcouru.this, Authentification.class);
                startActivity(intent);
